...
# Data specifications
parser.add_argument('--dir', type=str, default='/scratch_net/ofsoundof/yawli/logs_3d/',
                    help='log directory')
...
parser.add_argument('--model_one', default='one',
                    help='used to split the dataset. We use cross validation for training and testing. The dataset is '
                         'split into 2 equal groups. When one group is used for training, the other is used for testing.'
                         'The groups are form automatically according to the file system.')
parser.add_argument('--subset', default='.',
                    help='extract a subset of the whole dataset. Possible choices are ., ETH3D, MiddleBury, Collection,'
                         'SyB3R. The default choice . means the combination of all of the four subsets.')
parser.add_argument('--normal_lr', default='hr',
                    help='use hr or lr normal map. HR normal map is used for NHR while LR normal map is used for NLR.')
parser.add_argument('--input_res', default='lr',
                    help='use hr or lr input. HR input texture map is use for HRST-CNN while LR input texture map is '
...
parser.add_argument('--data_test_texture_sr', type=str, default='DIV2K',
                    help='super-resolve the input images for texture SR')
