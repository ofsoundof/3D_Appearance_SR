...
from dataloader_new import MSDataLoader
...
class Data:
    def __init__(self, args):
        ...
        elif args.data_test in ['Collection', 'ColMapMiddlebury', 'ETH3D', 'SyB3R']:
            module_test = import_module('data.benchmark_texture_sr')
            testset = getattr(module_test, 'BenchmarkTextureSR')(args, train=False)
        else:
